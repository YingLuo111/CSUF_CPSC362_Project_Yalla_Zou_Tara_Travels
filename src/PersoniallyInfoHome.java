/*
 * This is the class of the personally information homeJPanel 
 * this class set the some choice button
 * let the user can choice any of them to go to 
 * subJpanle of the personally Information JPanle
 * and can enter or select what thing they want 
 * booking or to see or want to choice.
 * show all of the information the user booking
 * and filled.
 */
import javax.swing.*;
import java.awt.*;
import java.awt.event.*;
//This is the class of the JPanel PersoniallyInfoHome and implements ActionListener
public class PersoniallyInfoHome extends JPanel implements ActionListener{
	...
	//constuctor the PersoniallyInfoHome
